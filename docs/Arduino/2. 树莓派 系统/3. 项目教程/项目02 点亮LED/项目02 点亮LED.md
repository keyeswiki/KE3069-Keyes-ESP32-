...
![图片不存在](../../../media/67aa93a8d10aed7a65361599021424b3.png)

选择正确的“**端口（COM）**”。
![图片不存在](../../../media/13abb53501c0cbc94b13d85d1953d6fc.png)

<span style="color: rgb(255, 76, 65);">注意：</span>对于macOS用户，如果上传失败，在单击之前，请设置波特率为**115200**。
![图片不存在](../../../media/e80c6546cd598ec044738c0f23e74404.png)

单击![图片不存在](../../../media/f7d940c91b28e05d5183000cc5cb7aa4.png)将项目代码上传到ESP32主板上。
![图片不存在](../../../media/f1a4cf7f1644a8593122104fff4feed9.png)
...
项目代码上传成功！
![图片不存在](../../../media/d5c55358fb1f31be686ec03213664450.png)
