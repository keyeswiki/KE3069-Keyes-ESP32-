...
本项目中使用的代码保存在在（即路径)：**..\Keyes ESP32 基础版学习套件\4. Arduino C 教程\1. Windows 系统\3. 项目教程\项目23 WiFi 工作模式\Project_23.1_WiFi_Station_Mode** 。
...
![图片不存在](../../../media/860aa375650b2334878e22a3d338bc9b.png)
...
本项目中使用的代码保存在在（即路径)：**..\Keyes ESP32 学习套件进阶版\4. Arduino C 教程\1. Windows 系统\3. 项目教程\项目23 WiFi 工作模式\Project_23.2_WiFi_AP_Mode** 。
...
![图片不存在](../../../media/be9accc8fe39ff50f3a35be6f9800b92.png)
...
本项目中使用的代码保存在在（即路径)：**..\Keyes ESP32 学习套件进阶版\4. Arduino C 教程\1. Windows 系统\3. 项目教程\项目23 WiFi 工作模式\Project_23.3_WiFi_Station_AP_Mode** 。
...
![图片不存在](../../../media/a581ba0f8f09a799f76a6369ed768fc0.png)
